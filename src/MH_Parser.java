...
class MH_Parser extends GenParser implements PARSER {
    ...
    String[] tableEntry (String nonterm, String tokClass) {
        ...
        /* sample code
        // #S -> epsilon | EVEN #S && #S
        if (nonterm.equals("#S")) { ##column of LL(1) parsing table
	        if (tokClass == null) return epsilon ; ##row of LL(1) parsing table
	        else if (tokClass.equals("&&")) return epsilon ; ##cell
	        else if (tokClass.equals("EVEN")) return EVEN_S_AND_S ;
	        else return null ;
	    } else return null ; ##ending
         */
        // Prog
